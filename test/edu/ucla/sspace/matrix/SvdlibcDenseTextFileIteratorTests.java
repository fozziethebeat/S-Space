...
public class SvdlibcDenseTextFileIteratorTests {
    ...
    public void testRemove() throws Exception {
        File f = getDenseTextSVDLIBCFile();
        Iterator<MatrixEntry> it = new SvdlibcDenseTextFileIterator(f);
        it.remove();
    }
    ...
    public static File getDenseTextSVDLIBCFile() throws Exception {
