 ...
 */
class ViewIntegerAsIntegerSparseVector extends IntegerVectorView
     ...
     */
    public <T extends SparseIntegerVector> 
            ViewIntegerAsIntegerSparseVector(T v) {
     ...
     */
    public <T extends SparseIntegerVector> 
            ViewIntegerAsIntegerSparseVector(T v, boolean isImmutable) {
     ...
     */
    public <T extends SparseIntegerVector> 
            ViewIntegerAsIntegerSparseVector(T v, int offset, int length) {
