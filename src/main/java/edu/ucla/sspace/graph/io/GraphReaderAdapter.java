...
public class GraphReaderAdapter implements GraphReader {
     ...
     * {@inheritDoc}
     */
    public WeightedGraph<WeightedEdge> readWeighted(
     ...
     * {@inheritDoc}
     */
    public DirectedGraph<DirectedEdge> readDirected(
            File f, Indexer<String> vertexLabels) throws IOException {
        throw new UnsupportedOperationException();
    }
     ...
     * {@inheritDoc}
     */
    public DirectedMultigraph<String> readDirectedMultigraph(
            File f, Indexer<String> vertexLabels) throws IOException {
        throw new UnsupportedOperationException();
    }
    ...
    public UndirectedMultigraph<String> readUndirectedMultigraph(
            File f, Indexer<String> vertexLabels) throws IOException {
        throw new UnsupportedOperationException();
    }
