...
public class RationalObjectCounter<T> 
    implements RationalCounter<T>, java.io.Serializable {
    ...
    /**
     * Creates an empty {@code RationalObjectCounter}.
     */
    public RationalObjectCounter() {
        counts = new TObjectDoubleHashMap<T>();
        sum = 0;
    }

    /**
     * Creates a {@code RationalObjectCounter} whose initial state has counted all of the
     * specified items.
     */
