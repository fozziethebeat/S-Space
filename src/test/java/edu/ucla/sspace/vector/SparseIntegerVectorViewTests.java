...
/**
 * Tests for the {@link SparseIntegerVectorView} class.
 */
public class SparseIntegerVectorViewTests {

    @Test public void testMagnitude() {
        SparseIntegerVector v = new CompactSparseIntegerVector(100);
        v.set(1, 1);
        v.set(3, 1);
        v.set(5, 1);
        v.set(7, 1);
        v.set(9, 1);
        SparseIntegerVector view = Vectors.subview(v, 0, 100);
