...
public class RubensteinGoodenoughWordSimilarityEvaluationTest {

    @Test public void testRAndG() throws IOException {
        File temp = File.createTempFile("RAndGTest", ".tst");
        temp.deleteOnExit();
        ...
        RubensteinGoodenoughWordSimilarityEvaluation eval =
            new RubensteinGoodenoughWordSimilarityEvaluation(temp);
