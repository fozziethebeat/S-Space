...
public class SparseSymmetricMatrixTests {

    @Test public void testSet() {
        SparseSymmetricMatrix ssm = new SparseSymmetricMatrix(new SparseHashMatrix(10, 10));
        ssm.set(5,1,2);
    ...
    @Test public void testRowVector() {
        SparseSymmetricMatrix ssm = new SparseSymmetricMatrix(new SparseHashMatrix(10, 10));
        ssm.set(5,1,2);
        SparseDoubleVector v = ssm.getRowVector(5);
    ...
    @Test public void testColVector() {
        SparseSymmetricMatrix ssm = new SparseSymmetricMatrix(new SparseHashMatrix(10, 10));
        ssm.set(5,1,2);
        SparseDoubleVector v = ssm.getColumnVector(5);
        assertEquals(2, v.get(1), .001);
