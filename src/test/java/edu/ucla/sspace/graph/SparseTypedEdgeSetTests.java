...
public class SparseTypedEdgeSetTests {
    ...
    @Test public void testSerialization() throws Exception {
        ...
        Field cacheField = SparseTypedEdgeSet.class.getDeclaredField("TYPE_INDICES");
        cacheField.setAccessible(true);
        Map<?,?> cache = (Map<?,?>)cacheField.get(null);

        Field typesField = SparseTypedEdgeSet.class.getDeclaredField("TYPES");
        ...
        SparseTypedEdgeSet<String> test =
            (SparseTypedEdgeSet<String>)(ois.readObject());
    ...
    @Test public void testSerializationWithConsistentTypeChanges() throws Exception {
        ...
        // equality case
        new SparseTypedEdgeSet<Object>(0).
